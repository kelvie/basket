...
dest_files=(
    ...
    "$LINKS/share/services/basket_config_features.desktop"
    "$LINKS/share/services/basket_config_notes.desktop"
...
source_files=(
    ...
    "$TARGET/src/basket_config_features.desktop"
    "$TARGET/src/basket_config_notes.desktop"
