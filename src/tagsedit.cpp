...
//TODO : QTreeWidget(parent), m_tagCopy(tagCopy), m_stateCopy(0)
{
...
//TODO : QListView(parent, name, flags)
{
}
...
//TODO : KDialog(KDialog::Plain, i18n("Customize Tags"), KDialog::Ok | KDialog::Cancel,
...
//
//	m_moveUp    = new KPushButton( KGuiItem("", "arrow-up"),   plainPage() );
//	m_moveDown  = new KPushButton( KGuiItem("", "arrow-down"), plainPage() );
