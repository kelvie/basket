...
//			if (shouldAsk) {
//				KMenu menu(parent);
//				menu.insertItem( SmallIconSet("goto-page"),     i18n("&Move Here\tShift"),      0 );
...
{
//	return ! KIconLoader::global()->loadIcon(icon, K3Icon::NoGroup, 16, KIcon::DefaultState, 0L, true).isNull();
}
