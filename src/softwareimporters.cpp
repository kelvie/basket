...
//TODO :  KDialog(KDialog::Swallow, i18n("Import Hierarchy"), KDialog::Ok | KDialog::Cancel,
//TODO               KDialog::Ok, parent, /*name=*/"ImportHierarchy", /*modal=*/true, /*separator=*/false)
{
...
{
//TODO	return m_choices->selectedId();
}

/** class TextFileImportDialog: */

TextFileImportDialog::TextFileImportDialog(QWidget *parent)
//TODO : KDialog(KDialog::Swallow, i18n("Import Text File"), KDialog::Ok | KDialog::Cancel,
//TODO               KDialog::Ok, parent, /*name=*/"ImportTextFile", /*modal=*/true, /*separator=*/false)
{
//	QWidget *page = new QWidget(this);
//	QVBoxLayout *topLayout = new QVBoxLayout(page, /*margin=*/0, spacingHint());
//
