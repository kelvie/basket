...
//TODO : QWidget(/*parent=*/0, /*name=*/0, WType_Popup | WNoAutoErase),
//TODO   m_selector(parent)
{
	hide();
...
//TODO : QComboBox(/*editable=*/false, parent, name),
//TODO   m_color(color), m_defaultColor(defaultColor)
{
	init();
}
...
//TODO : QComboBox(/*editable=*/false, parent, name),
//TODO   m_color(color), m_defaultColor()
{
	init();
}
