...
{
	kDebug() << "Import Baskets: Preparing..." << endl;
...
QDomElement FormatImporter::importBasket(const QString &folderName)
{
	...
	/* FIXME 1.5 if (backgroundColor.isValid() && (backgroundColor != KColorScheme(KColorScheme::View).background().color())) { // Use the default color if it was already that color:
